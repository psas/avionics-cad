...
1. Naming Convention
 ...
 node5 = USB Node v5, which is (ARM7 + SPSv3) 2009 capstone design
...
2. Contents
 ...
 lv2-node4-frontend     LV2c generic USB node (Capstone 2006)

 lv2-node5-aps          LV2c avionics power system node
 lv2-node5-pyro         LV2c pyrotechnic node
